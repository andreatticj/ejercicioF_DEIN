package eu.andreatt.ejerciciof_dein.application;
...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/eu/andreatt/ejerciciof_dein/fxml/ejercicioF.fxml"));
        Scene scene = new Scene(fxmlLoader.load(), 500, 450);
        Image icon = new Image(getClass().getResourceAsStream("/eu/andreatt/ejerciciof_dein/images/agenda.png"));
